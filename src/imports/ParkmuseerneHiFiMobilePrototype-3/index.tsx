...
function Heading() {
  return (
    <div className="absolute h-[97.488px] left-[136px] top-[401.92px] w-[233.992px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-full [word-break:break-word] absolute font-['Montagu_Slab:Regular',sans-serif] font-normal leading-[32.5px] left-[240.49px] text-[26px] text-right text-white top-[49.09px] tracking-[0.52px] uppercase w-[325px]">YOU JUST ENTERED PARKMUSEERNE</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="content-stretch flex flex-col h-[52px] items-start relative shrink-0" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Source_Serif_Pro:Regular',sans-serif] leading-[26px] not-italic relative shrink-0 text-[#2a2a2a] text-[16px] w-[350px]">You have scanned the QR code and are now ready to explore Parkmuseerne.</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#e9672b] relative shrink-0 w-[349.998px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center py-[16px] relative size-full">
        <p className="[word-break:break-word] font-['Source_Serif_Pro:SemiBold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.4px] whitespace-nowrap">Continue to map</p>
      </div>
    </div>
  );
}
